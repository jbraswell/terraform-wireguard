...
| Name | Version |
|------|---------|
| <a name="requirement_cloudscale"></a> [cloudscale](#requirement\_cloudscale) | ~> 3.2.0 |
...
| <a name="provider_cloudscale"></a> [cloudscale](#provider\_cloudscale) | 3.2.0 |
...
| Name | Type |
|------|------|
| [cloudscale_server.wireguard](https://registry.terraform.io/providers/cloudscale-ch/cloudscale/latest/docs/resources/server) | resource |
...
| <a name="input_cloudscale_token"></a> [cloudscale\_token](#input\_cloudscale\_token) | Cloudscale authentication token. | `string` | n/a | yes |
| <a name="input_region"></a> [region](#input\_region) | The wireguard server's desired region. Valid regions at https://www.cloudscale.ch/en/api/v1#regions. | `string` | n/a | yes |
