...
variable "region" {
  type        = string
  description = "The wireguard server's desired region. Valid regions at https://www.cloudscale.ch/en/api/v1#regions."
}
...
variable "cloudscale_token" {
  type        = string
  description = "Cloudscale authentication token."
}
