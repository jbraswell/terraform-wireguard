...
variable "region" {
  type        = string
  description = "The wireguard server's desired region. Valid regions at https://www.huaweicloud.com/intl/en-us/securecenter/data_protection/region_query.html."
}
